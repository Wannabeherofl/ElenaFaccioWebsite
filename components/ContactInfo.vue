    ...
    <main class="max-4-4xl mx-auto">
      ...
      <section id="hero" class="hero flex flex-col-reverse justify-center sm:flex-row p-6 items-center gap-8 mb-12">
        ...
        <article>
          ...
          <p class="max-w-md text-2xl mt-4 text-center sm:text-left text-slate-700 dark:text-white">
          ...
          <p class="max-w-md text-2xl mt-4 ml-14 text-center sm:text-left text-slate-700 dark:text-white">
            <a>+39 (346) 758-7566</a>
          </p>
        </article>
      </section>
