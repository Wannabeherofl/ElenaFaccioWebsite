    ...
    <main class="max-w-4xl mx-auto">
      ...
      <section id="reviews" class="p-6 pb-0 mb-0 my-12">
        ...
        <div class="pt-5 flex items-center text-center gap-8 Second-Font text-2xl text-slate-700 dark:text-slate-400">
          <p class="w-1/2">
            "I'm always very focused on the project and in doing my best pursuing firms goals"
          </p>
          <p class="w-1/2">
            "you will not feel like you are alone if im next to you"
          </p>
          <p class="w-1/2">
            "Yes"
          </p>
          <p class="w-1/2">
            "I study and read a lot, im a book lover and i am passionate to leanr and discover new ideas and know-hows"
          </p>
          <p class="w-1/2">
            "One of my focuses are listen to people and be open. I manage on projects pursuing goals of effectiveness but always listening to people"
          </p>
        </div>
      </section>
    </main>
