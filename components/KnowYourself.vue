    ...
    <main class="max-4-4xl mx-auto">
      ...
      <section id="hero" class="hero flex flex-col-reverse justify-center sm:flex-row p-6 items-center gap-8">
        <article>
            ...
            <p class="Second-Font max-w-2xl text-2xl mt-4 text-center sm:text-left text-slate-700 dark:text-white">
                Know your identity means: you and your team make clear the skills for known situations, and know your attributes in unknow situation.<br>
