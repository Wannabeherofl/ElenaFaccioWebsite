...
<template>
    <main class="max-4-4xl mx-auto">
      ...
      <section id="hero" class="hero flex flex-col-reverse justify-center sm:flex-row p-6 items-center mb-12">
        <h2 class="Third-font max-w-2xl text-6xl text-center text-slate-900 dark:text-white">
        ...
        <article>
          <p class="Second-Font max-w-2xl text-3xl mt-4 text-center sm:flex-row text-slate-700 dark:text-white vl">
            Know your <strong class="text-[#fdba74]">identity</strong> means: you and your team make clear the skills for known situations, and know your attributes in unknow situation.<br>
            If you know your individuality you can comunicate it better, and build trust about your identity to others.<br>
